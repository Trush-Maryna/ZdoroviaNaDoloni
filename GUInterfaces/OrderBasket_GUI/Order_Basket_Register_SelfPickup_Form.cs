    ...
    public partial class Order_Basket_Register_SelfPickup_Form : Form
    {
        ...
        private void Btn_Confirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                object fileWord = ReceiptWord.CreateReceiptSelfPickup(panelDataList, priceTotal, countTotal, pharmacyMarks);
                object fileExcel = ReceiptExcel.CreateReceiptSelfPickup(panelDataList, priceTotal, countTotal, pharmacyMarks);
